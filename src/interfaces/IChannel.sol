...
interface IChannel {
     ...
     */
    function open(ITypes.Channel calldata ch, ITypes.Asset calldata deposit) external returns (bytes32 channelId);
     ...
     */
    function close(bytes32 channelId, bytes calldata state, ITypes.Signature[2] calldata signatures) external;
     ...
     */
    function challenge(bytes32 channelId, bytes calldata state) external;
